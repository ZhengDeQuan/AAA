...
class TFLearnWideAndDeep(object):
    ...
    def load_data(self, train_dfn="Data/train_ins_continues.txtlineNUM_videoID",
                  eval_dfn="Data/eval_ins_continues.txtlineNUM_videoID"):
    # def load_data(self,
    ...
    def load_test_data(self,test_dfn="Data/test_ins_continues.txtlineNUM_videoID"):
