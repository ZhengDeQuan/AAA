...
def generator(x, reuse=False):
    with tf.variable_scope('Generator', reuse=reuse):
        ...
        x = zqtflearn.fully_connected(x, image_dim, activation='sigmoid')
        return x
...
# Build Networks
gen_input = zqtflearn.input_data(shape=[None, z_dim], name='input_noise')
disc_input = zqtflearn.input_data(shape=[None, 784], name='disc_input')
