...
net = zqtflearn.resnext_block(net, n, 16, 32)
net = zqtflearn.resnext_block(net, 1, 32, 32, downsample=True)
net = zqtflearn.resnext_block(net, n - 1, 32, 32)
net = zqtflearn.resnext_block(net, 1, 64, 32, downsample=True)
net = zqtflearn.resnext_block(net, n - 1, 64, 32)
...
opt = zqtflearn.Momentum(0.1, lr_decay=0.1, decay_step=32000, staircase=True)
net = zqtflearn.regression(net, optimizer=opt,
                           loss='categorical_crossentropy')
# Training
model = zqtflearn.DNN(net, checkpoint_path='model_resnext_cifar10',
