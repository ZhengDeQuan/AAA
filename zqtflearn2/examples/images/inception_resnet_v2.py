...
import zqtflearn
import zqtflearn.activations as activations
# Data loading and preprocessing
import zqtflearn.datasets.oxflower17 as oxflower17
from zqtflearn.activations import relu
from zqtflearn.data_utils import shuffle, to_categorical
from zqtflearn.layers.conv import avg_pool_2d, conv_2d, max_pool_2d
from zqtflearn.layers.core import dropout, flatten, fully_connected, input_data
from zqtflearn.layers.merge_ops import merge
from zqtflearn.layers.normalization import batch_normalization
from zqtflearn.utils import repeat
...
network = zqtflearn.regression(loss, optimizer='RMSprop',
                               loss='categorical_crossentropy',
                               learning_rate=0.0001)
model = zqtflearn.DNN(network, checkpoint_path='inception_resnet_v2',
