...
with tf.Graph().as_default():
    ...
    def dnn(x):
        with tf.name_scope('Layer1'):
            ...
            zqtflearn.add_weights_regularizer(W1, 'L2', weight_decay=0.001)
        ...
        with tf.name_scope('Layer2'):
            ...
            tf.add_to_collection(tf.GraphKeys.ACTIVATIONS, x)
            # Add weights regularizer (Regul. summary automatically added)
            zqtflearn.add_weights_regularizer(W2, 'L2', weight_decay=0.001)
