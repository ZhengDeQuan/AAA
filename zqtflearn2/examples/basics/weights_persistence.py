...
dense1_vars = zqtflearn.variables.get_layer_variables_by_name('dense1')
# Get a variable's value, using model `get_weights` method:
print("Dense1 layer weights:")
print(model.get_weights(dense1_vars[0]))
# Or using generic zqtflearn function:
print("Dense1 layer biases:")
with model.session.as_default():
    print(zqtflearn.variables.get_value(dense1_vars[1]))
...
with model.session.as_default():
    print(zqtflearn.variables.get_value(dense2.b))
