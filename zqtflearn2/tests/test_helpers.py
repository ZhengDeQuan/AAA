...
class TestHelpers(unittest.TestCase):
    """
    Testing helper functions from zqtflearn/helpers
    """

    def test_variable(self):
        # Bulk Tests
        with tf.Graph().as_default():
            W = zqtflearn.variable(name='W1', shape=[784, 256],
                                   initializer='uniform_scaling',
                                   regularizer='L2')
            W = zqtflearn.variable(name='W2', shape=[784, 256],
                                   initializer='uniform_scaling',
                                   regularizer='L2')
    ...
    def test_regularizer(self):
        ...
        with tf.Graph().as_default():
            ...
            zqtflearn.add_weights_regularizer(W, 'L2', weight_decay=0.001)
    ...
    def test_summarizer(self):
        ...
        with tf.Graph().as_default():
            ...
            import zqtflearn.helpers.summarizer as s
