...
import time
import os
import custom_tag_config2
from custom_tag_config2 import custom_tags
...
class WideAndDeep(object):
    def __init__(self,
        ...
        self.sess.run([custom_tag_config2.embedding_matrix_variable.initializer],feed_dict={custom_tag_config2.embedding_matrix_placeholder:custom_tag_config2.embedding_matrix})
        del custom_tag_config2.embedding_matrix
    ...
    def _realize_mappings(self):
        with tf.device('/cpu:0'), tf.variable_scope('word_embedding'):
            ...
            print("batch_embedding_res.shape = ",batch_embedding_res.shape)
            # import pdb
            # pdb.set_trace()
...
if __name__ == "__main__":
    ...
    A = WideAndDeep(batch_size=10,eval_freq=2,tag2value=tag2value,tag2valueOneline=tag2valueOneline,custom_tags = custom_tags,
                    train_epoch_num=1,
    ...
    #A.restore_model(save_dir="/home2/data/zhengquan/WAD_filterEmbedding/",prefix="auc=0.516")
