...
class TFLearnWideAndDeep(object):
    ...
    def read_embedding(self, embedding_path,vocab):
        ...
        for key in pretrained_embedding:
            ...
            static[key]=pretrained_embedding[key]["num"]
        pickle.dump(static,open("static_about_comment.pkl","wb"))
        print("saving static about comment")
        import pdb
        pdb.set_trace()
        return emb
    ...
    def deep_model(self, wide_inputs, deep_inputs, n_inputs, n_nodes=[100, 50], use_dropout=False):
        ...
        if os.path.exists('self_embedding.pkl'):
            ...
            self.embedding = self.read_embedding(embedding_path='videoID_vector.pkl', vocab = self.vocab)
    ...
    def load_data(self,
                  train_dfn="Data/train_ins_continues.txtlineNUM_videoID",
    ...
    def load_test_data(self,
                       test_dfn="Data/test_ins_continues.txtlineNUM_videoID"):
    # def load_test_data(self,
