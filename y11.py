...
class WideAndDeep(object):
    def __init__(self,
        ...
        self.confidence_rates = confidence_rates
    ...
    def _build_loss(self):
        ...
        # Label smoothing
        if len(self.confidence_rates) > 0:
            cr0, cr1 = self.confidence_rates
            table = tf.convert_to_tensor(
                [[cr0, 1. - cr0],
                 [1. - cr1, cr1]])

            labels = tf.nn.embedding_lookup(table, tf.cast(self._Y,dtype=tf.int64))
